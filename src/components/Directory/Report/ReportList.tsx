...
import {TApiReport, TReport} from "../../../api/type";
...
export interface TReportList extends IMapStateToProps, IMapDispatchToProps {

}

const ReportList: React.FC<TReportList> = (props) => {
    let pages = [];
