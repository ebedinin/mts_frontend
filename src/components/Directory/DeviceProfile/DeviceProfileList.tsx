...
import {TApiReport, TDeviceProfile} from "../../../api/type";
...
export interface IDeviceProfileList extends IMapStateToProps, IMapDispatchToProps {

}

const DeviceProfileList: React.FC<IDeviceProfileList> = (props) => {
    let pages = [];
